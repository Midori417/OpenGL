...
* @return false 初期化失敗
*/
bool MainScene::Initialize(Engine& engine)
{
    // カメラを作成
    ...
    //{
        ...
        auto ground = engine.Create<GameObject>("Ground", Vector3(0, -7.8f, 0));
        {
            ...
            renderer->mesh->materials[0]->texBaseColor = engine.GetTexture("Res/Map/Gross.tga");
    ...
    //        renderer->mesh = engine.GetStaticMesh("Res/Map/Load.obj");
    //        renderer->mesh->materials[0]->texBaseColor = engine.GetTexture("Res/Default/Texture/white.tga");
    //    }

    //    auto biru1 = engine.Create<GameObject>("Biru", Vector3(37, 0, 67));
    //    
    //    biru1->AddComponent<MeshRenderer>()->mesh = engine.GetStaticMesh("Res/Map/Biru01.obj");
    //    biru1->SetParent(load);

    //    auto biru2 = engine.Create<GameObject>("Biru2", Vector3(-33, 0, 56));
    //    biru2->AddComponent<MeshRenderer>()->mesh = engine.GetStaticMesh("Res/Map/Biru02.obj");
    ...
    //    biru3->AddComponent<MeshRenderer>()->mesh = engine.GetStaticMesh("Res/Map/Biru03.obj");
    //    biru3->SetParent(load);

    //    auto biru4 = engine.Create<GameObject>("Biru4", Vector3(42, 0, -67));
    //    biru4->AddComponent<MeshRenderer>()->mesh = engine.GetStaticMesh("Res/Map/Biru02.obj");
    //    biru4->SetParent(load);

    //    auto biru5 = engine.Create<GameObject>("Biru5", Vector3(-39, 0, -63));
    //    biru5->AddComponent<MeshRenderer>()->mesh = engine.GetStaticMesh("Res/Map/Biru03.obj");
    //    biru5->SetParent(load);

    //    auto biru6 = engine.Create<GameObject>("Biru6", Vector3(209, 0, 244));
    //    biru6->AddComponent<MeshRenderer>()->mesh = engine.GetStaticMesh("Res/Map/Biru01.obj");
    ...
    material->texBaseColor = engine.GetTexture("Res/sky_sphere/sky2.tga");
    SetSkeyMaterial(material);
...
* @param engine エンジン
*/
void MainScene::Finalize(Engine& engine)
{
